...
createinvokes1:
	python -u invokesCreator.py 0 >> database/transactions/multiout.out && python -u invokesCreator.py 1 >> database/transactions/multiout.out &
	
	python -u invokesCreator.py 2 >> database/transactions/multiout.out && python -u invokesCreator.py 3 >> database/transactions/multiout.out && python -u invokesCreator.py 4 >> database/transactions/multiout.out &
	
	python -u invokesCreator.py 5 >> database/transactions/multiout.out && python -u invokesCreator.py 6 >> database/transactions/multiout.out && python -u invokesCreator.py 7 >> database/transactions/multiout.out &
...
createinvokes2:
	...
	python -u invokesCreator.py 21 >> database/transactions/multiout.out && python -u invokesCreator.py 22 >> database/transactions/multiout.out && python -u invokesCreator.py 23 >> database/transactions/multiout.out &
	
	python -u invokesCreator.py 24 >> database/transactions/multiout.out && python -u invokesCreator.py 25 >> database/transactions/multiout.out && python -u invokesCreator.py 26 >> database/transactions/multiout.out &
